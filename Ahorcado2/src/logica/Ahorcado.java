...
public class Ahorcado {
    ...
    public Ahorcado(JTextField campoPalabra, String palabra, JLabel errores, JLabel campoIntentos, JLabel largoPalabra) {
        ...
        this.largoPalabra.setText("Palabra en Ingles de " + this.palabra_secreta.length + " letras.");
    ...
    public void validarPalabra(char letraIngresada) {
        if (jugar) {
            ...
            if (this.intentos == 7) {
                ...
                JOptionPane.showMessageDialog(null, "Nadie ganó, la palabra era " + respuesta, "Game Over", JOptionPane.ERROR_MESSAGE);
            } else {
